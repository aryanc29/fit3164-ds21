...
# Create a separate Base for BOM models to avoid conflicts
BOMBase = declarative_base()

class BOMWeatherStation(BOMBase):
...
class BOMDataIngestionLog(BOMBase):
